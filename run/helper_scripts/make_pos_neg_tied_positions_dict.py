...
def main(json_list, homooligomer, position_list, chain_list, pos_neg_chain_list, pos_neg_chain_betas):
    ...
    if homooligomeric_state == 0:
        ...
        for result in json_list:
            ...
            for chains, t_list in zip(chain_list_input, tied_list):  # this is the list of constraints
                for i, pos in enumerate(tied_list[chidx]):  # this is the list of tied_positions for a given constraint ?
                    temp_dict = {}
                    for j, chain in enumerate(chains):
                        # final_pos = pos  # how this used to work
